...
Categorize students with a hierarchical clustering algorithm on event logs of our statistical exam and strengthen the analysis with a comparison to a proctored exam group
]
...
```{r, out.width="100%", fig.align="center", fig.cap=c("<strong> Figure 1: </strong> Dendrogram produced by average linkage clustering of the proctored control group (2018/19). <strong> G-L </strong> mark the clusters with the lowest dissimilarity"), echo=FALSE}

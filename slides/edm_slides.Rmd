...
```{r, out.width="80%", fig.align="center", fig.cap=c("<strong>Figure 4.1:</strong> Comparison of the event logs and achieved points of the clusters <strong>C</strong> and <strong>D</strong> from the test group (2020/21). Above the scatter plot, a bar chart is added to compare the points per subtask."), echo=FALSE}
...
```{r, out.width="80%", fig.align="center", fig.cap=c("<strong>Figure 4.1:</strong> Comparison of the event logs and achieved points of the clusters <strong>E</strong> and <strong>F</strong> from the test group (2020/21). Above the scatter plot, a bar chart is added to compare the points per subtask."), echo=FALSE}
...
```{r, out.width="80%", fig.align="center", fig.cap=c("<strong>Figure 4.1:</strong> Comparison of the event logs and achieved points of the clusters <strong>G</strong> and <strong>H</strong> from the control group (2018/19). Above the scatter plot, a bar chart is added to compare the points per subtask."), echo=FALSE}
...
```{r, out.width="80%", fig.align="center", fig.cap=c("<strong>Figure 4.1:</strong> Comparison of the event logs and achieved points of the clusters <strong>I</strong> and <strong>J</strong> from the control group (2018/19). Above the scatter plot, a bar chart is added to compare the points per subtask."), echo=FALSE}
...
```{r, out.width="80%", fig.align="center", fig.cap=c("<strong>Figure 4.1:</strong> Comparison of the event logs and achieved points of the clusters <strong>K</strong> and <strong>L</strong> from the control group (2018/19). Above the scatter plot, a bar chart is added to compare the points per subtask."), echo=FALSE}

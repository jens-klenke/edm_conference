...
<ul>
    <li>The control group has an overall higher level of dissimilarity and doesn´t contain any strikingly similar cluster.</li>
    <li>The six lowest cluster from the test group stand out in terms of similarity, specially cluster <strong>A</strong>, <strong>B</strong> and <strong>E</strong>.</li>
</ul>
...
.panelset[
.panel[.panel-name[Control group2]

```{r, out.height=="50%", fig.align="center", fig.cap=c("<strong> Figure 3: </strong> Dendogram produced by average linkage clustering of the unproctored test group (2018/19). <strong> G-L </strong> mark the clusters with the lowest dissimilarity"), echo=FALSE}
...
.panel[.panel-name[Test group2]

```{r, out.width="60%", fig.align="center", fig.cap=c("<strong>Figure 4:</strong>  Dendogram produced by average linkage clustering of the unproctored test group (2020/21). <strong> A-F </strong> mark the clusters with the lowest dissimilarity."), echo=FALSE}
...
* The control group has an overall higher level of dissimilarity and doesn´t contain any strikingly similar cluster. 
* The six lowest cluster from the test group stand out in terms of similarity, specially cluster **A**, **B** and **E**.
...
<h1>Empirical results — <span style="font-size: 0.8em;">Cluster comparison</span></h1>

```{r, out.width="80%", fig.align="center", fig.cap=c("<strong>Figure 2:</strong> Comparison of the event logs and achieved points for each of the test group´s (2020/21) six lowest dissimilaity clusters (<strong>A-F</strong>). Above the scatter plot, a bar chart is added to compare the points per subtask."), echo=FALSE}
...
```{r, out.width="80%", fig.align="center", fig.cap=c("<strong> Figure 4: </strong> Comparison of the event logs and achieved points for each of the control group´s (2018/19) six lowest dissimilaity clusters (<strong>G-L</strong>). Above the scatter plot, a bar chart is added to compare the points per subtask."), echo=FALSE}

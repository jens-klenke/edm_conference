...
```{r, out.width="85%", fig.align="center", fig.cap=c("Figure 2: Comparison of the event logs and achieved points for each of the test group´s (2020/21) six lowest dissimilaity clusters (A-F). Above the scatter plot, a bar chart is added to compare the points per subtask."), echo=FALSE}

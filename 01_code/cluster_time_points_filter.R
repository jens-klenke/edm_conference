...
load("00_data/Distmat_filtered.Rdata")
...
points_18_19 %<>%
  dplyr::mutate(points = dplyr::recode(points, "-1" = 0))
...
save(points_18_19, points_20_21,
     file = here::here("00_data/points.Rdata"))
...
# Remove students with less than 25% of points from JACK exercises
S_v_18_19_filter_points <- S_v_18_19_filter %>% points_fun_filter(points_18_19, 
                                                                  min = 475)
S_v_20_21_filter_points <- S_v_20_21_filter %>% points_fun_filter(points_20_21, 
                                                                  min = 401)
...
S_v_18_19_filter_points %<>% normalise_S_v_time_points()
S_v_20_21_filter_points %<>% normalise_S_v_time_points()

# Add up to get a global measure
dist_mat_global_filter_time_points_18_19 <-  S_v_18_19_filter_points %>%   
...
dist_mat_global_filter_time_points_20_21 <-  S_v_20_21_filter_points %>%   
  pivot_longer(cols = c(points_L, L_1, L_2)) %>%
  group_by(v_1, v_2) %>%
  plyr::arrange(v_1, v_2, name) %>%
  dplyr::summarise(dist_L1 = weighted.mean(value[name != "L_2"], 
...
rm(list = setdiff(ls(), c("S_v_18_19_filter_points", "S_v_20_21_filter_points",
                          "dist_mat_global_filter_time_points_18_19", "dist_mat_global_filter_time_points_20_21")))
save(S_v_18_19_filter_points, S_v_20_21_filter_points,
          dist_mat_global_filter_time_points_18_19, dist_mat_global_filter_time_points_20_21,
          file = here::here("00_data/Distmat_filter_time_points.Rdata"))
...
# L1
L1_18_19_complete_filter_time_points <- L1_cluster_fun(dist_mat = dist_mat_global_filter_time_points_18_19)
L1_20_21_complete_filter_time_points <- L1_cluster_fun(dist_mat = dist_mat_global_filter_time_points_20_21)

L1_18_19_single_filter_time_points <- L1_cluster_fun(dist_mat = dist_mat_global_filter_time_points_18_19, method = "single")
L1_20_21_single_filter_time_points <- L1_cluster_fun(dist_mat = dist_mat_global_filter_time_points_20_21, method = "single")

L1_18_19_av_filter_time_points <- L1_cluster_fun(dist_mat = dist_mat_global_filter_time_points_18_19, method = "average")
L1_20_21_av_filter_points <- L1_cluster_fun(dist_mat = dist_mat_global_filter_time_points_20_21, method = "average")

L1_18_19_ward_filter_time_points <- L1_cluster_fun(dist_mat = dist_mat_global_filter_time_points_18_19, method = "ward.D2")
L1_20_21_ward_filter_time_points <- L1_cluster_fun(dist_mat = dist_mat_global_filter_time_points_20_21, method = "ward.D2")

# L2
L2_18_19_complete_filter_time_points <- L2_cluster_fun(dist_mat = dist_mat_global_filter_time_points_18_19)
L2_20_21_complete_filter_time_points <- L2_cluster_fun(dist_mat = dist_mat_global_filter_time_points_20_21)

L2_18_19_single_filter_time_points <- L2_cluster_fun(dist_mat = dist_mat_global_filter_time_points_18_19, method = "single")
L2_20_21_single_filter_time_points <- L2_cluster_fun(dist_mat = dist_mat_global_filter_time_points_20_21, method = "single")

L2_18_19_av_filter <- L2_cluster_fun(dist_mat = dist_mat_global_filter_time_points_18_19, method = "average")
L2_20_21_av_filter <- L2_cluster_fun(dist_mat = dist_mat_global_filter_time_points_20_21, method = "average")

L2_18_19_ward_filter <- L2_cluster_fun(dist_mat = dist_mat_global_filter_time_points_18_19, method = "ward.D2")
L2_20_21_ward_filter <- L2_cluster_fun(dist_mat = dist_mat_global_filter_time_points_20_21, method = "ward.D2")


rm(list = setdiff(ls(), ls()[startsWith(ls(), "L") & !endsWith(ls(), "fun")]))
save.image("00_data/Cluster_filter_time_points.Rdata")
...
plot_all_fun_points <- function(name, save.dendro = TRUE) {
  ...
  if(save.dendro) {
    ggsave(filename = paste0(
      here::here("04_plots/Dendrogram/time_points_filtered"), "/", var_name, ".pdf"), 

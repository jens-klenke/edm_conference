...
* The study analyzed data from the "Descriptive Statistics" course at the University Duisburg-Essen, Germany, with the intent to compare the outcomes of an unproctored exam ($N=151$) during the COVID-19 pandemic with a proctored exam ($N=109$) held in-person before the pandemic.
...
knitr::include_graphics(here::here('resources/graphics/group_B.png'))
#png ratio 1400 750
...
knitr::include_graphics(here::here('resources/graphics/Rplot09.png'))
